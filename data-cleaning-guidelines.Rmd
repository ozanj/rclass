...
Investigating data is time-consuming and requires using many different methods to detect unexpected, incorrect, and inconsistent data. While this is not a linear process, here is an outline of general steps to take when first investigating data. We provide syntax examples of each step below. 
...
## 2.3 Cleaning Data Via Creating New Variables: 
Remove, correct, or impute anomalies.

**Steps of creating new variables:**

  - Investigate input variable(s) 
