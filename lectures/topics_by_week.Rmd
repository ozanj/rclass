...
STUFF TO COVER FOR LOOPS; 9/18

- accessing elements of objects [DONE]
- intro to loops/components of a loop  [DONE]
- ways to loop over a vector  [DONE]
...
- when and how to write a loop 
- tasks achieved by body of loop
    - modify existing object
        - this would include adding new variable to existing object
        
        - potential practical examples
            - create new variables or modify existing variables [replace negative values with missing]
            - 
    - create new object
        - e.g., create a vector that is entirely separate from the object it is based on 
        
        

    - other [don't know where it fits]
        - read in multiple datasets
        - create frequency table for each institution
        - 


OLDER
- review concepts that are relevant for loops
    - vectors vs. lists
    - accessing elements of vectors [subsetting]
        - subsetting elements of vectors [un-named]
        - subsetting named vectors
    - accessing elements of lists
        - [] to extract a sub-list; result will always be a list
        - [[]] to extract a single component from a list; it removes level of hierarchy
            - $ is a shorthand for extracting named elements of a list. It works similarly to [[ except that you don’t need to use quotes.
                - remind students that we have seen this before
...
- looping over values or names
- looping over indices
- explain Wickham approach to for loop [later]
