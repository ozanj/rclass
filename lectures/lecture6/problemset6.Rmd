...
XIN - ADD A COUPLE QUESTIONS WHERE YOU ASK STUDENTS TO USE set_variable_labels() and set_value_labels() to convert variables to class=labelled. maybe one set of questions where the input variables are factor variables. and another set of questions where the input variables are simple integer variables w/ no more complicated class. you may have to create the desired input variables to do this.
