...
Using the example from the previous slide as a guide, what is the value of event date for:  
- the first event, second event, third event, fourth event, and fifth event for each event type (2-year, 4-year, etc.)?  
