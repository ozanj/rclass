...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#DO NOT WORRY ABOUT THIS}
\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{file.exists}\NormalTok{(}\StringTok{"fp2.JPG"}\NormalTok{)) \{}
  \KeywordTok{download.file}\NormalTok{(}\DataTypeTok{url =}\StringTok{"https://github.com/ozanj/rclass/raw/master/lectures/lecture2/fp2.JPG"}\NormalTok{,}
                \DataTypeTok{destfile =} \StringTok{'fp2.JPG'}\NormalTok{,}
...
Create a printing exercise using the df\_school data frame
