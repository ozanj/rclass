...
3. These questions refer to the variable `school_type` within the object `df_school_all`. Run the appropriate R commands within the chunk below and write substantive responses below each question.
