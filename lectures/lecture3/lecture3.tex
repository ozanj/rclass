...
\item
  ...
  \texttt{df\_event\_temp} and create \texttt{event\_typev2} based on
  \texttt{event\_type} with these categories:
...
following categories: - ``instate\_firstgen''; ``instate\_nonfirstgen'';
