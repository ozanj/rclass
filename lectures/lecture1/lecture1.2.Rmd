...
subtitle:  "DUC 263: Introduction to Programming and Data Management Using R"
...
```{r}
?c
x <- c(4, 7, 9) # create object called x, which is a vector with three elements (each an integer)
x # print object x
```
...
- [LINK HERE](https://ozanj.github.io//rclass//lectures//lecture1//data-structures-overview.png)
