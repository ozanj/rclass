...
**Note: R bootcamp (Step 5 below) walks you through installing R and RStudio if you would like to skip to that section for Steps 2 and 3.**  


## 1. Create a piazza account  
  * We will be conducting all class-related discussion on this platform instead of using CCLE.  
  * We have added your email to the Piazza site for this class.  
  * Course resources have not been posted. We will post more information as the quarter approaches  
  * If you did not receive an email invitation to join our class piazza page follow-up with me.
...
## 2. Install R 
  ...
  * Select "Download R for Windows"  
      ...
      * Click "Download R 3.6.1 for Windows"  
...
## 3. Install RStudio  
  ...
  * Select "RStudio 1.2.1335 - Windows 7+ (64-bit)" for Windows users  
  * Select "RStudio 1.2.1335 - macOS 10.12+ (64-bit)" for Mac users  
...
## 4. Create R Markdown file that “knits” HTML document in RStudio  
  ...
  * Steps to follow to create R Markdown file that knits HTML document  
    ...
    * Give your file a name and save (can delete later) in place that is easy to locate (Desktop, Dowonloads, etc.)  
    * You should have a saved HTML file (extension .HTML) and an R markdown file (extension .Rmd)  
    
## 5. Complete free R bootcamp tutorial [here](https://www.teamleada.com/courses/r-bootcamp)  

  * Follow the link and select "Try for free"  
  * Create an account  
...
## 7. Install tinytex  
  ...
  * We **strongly recommend** installing **tinytex** in RStudio because it is smaller in size and it only installs LaTeX packages you need. **However, if you have MikTeX/MacTeX already installed** on your computer we recommend you update to the most current version of MikTeX/MacTeX.  
  ...
  * [Instructions](https://github.com/ozanj/rclass/raw/master/miktex_mactex_instructions.pdf) for installing MikTeX/MacTeX 
...
## 9. Create R Markdown file that “knits” (PDF) beamer presentation in RStudio  
  ...
  * Steps to follow to create R Markdown file that knits beamer presentation  
    ...
    * Give your file a name and save (can delete later) in place that is easy to locate  
    * You should have a saved pdf file (extension .pdf) and an R markdown file (extension .Rmd)  
    * If you were unable to knit to pdf in the step above, this may not work for you  
    * If you receive an error shoot me an email and we can troubleshoot together  
