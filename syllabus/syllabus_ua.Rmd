...
If you feel sick, or may have been in contact with someone who is infectious, please stay home and self-quarantine. Per University recommendations [https://covid19.arizona.edu/](https://covid19.arizona.edu/), monitor your symptoms and seek emergency care immediately if your illness is worsening.  If seeking medical care, call the doctor's office or emergency room ahead and tell them about your symptoms.
...
## Module 2, 9/3/2020: Introduction to using tidyverse to investigate data patterns
...
## Module 3, 9/10/2020: Introduction to using "base R" to investigate data patterns
...
## Module 4, 9/17/2020: Pipes and variable creation
...
## Module 5, 9/24/2020:  Processing across rows
...
## Module 6, 10/1/2020:  Augmented vectors, Survey data, and exploratory data analysis
...
## Module 7, 10/8/2020:  Guidelines for investigating, cleaning, and creating variables
- Problem set due (before class): Yes
- Reading (after class): TBD

## Module 8, 10/15/2020:  Tidy Data
...
## Module 9, 10/22/2020:  Joining multiple datasets

- Problem set due (before class): Yes
- Reading (after class): W&G 13

## Module 10, 10/29/2019:  Acquiring data

- Problem set due (before class): Yes
- Reading (after class): W&G 11

## Module 11, 11/5/2020:  Working with Strings and Date/Time Variables

- Problem set due (before class): Yes
- Reading (after class): W&G 19


## Module 12, 11/12/2019: Accessing object elements and looping 
...
## Module 13, 12/3/2020: : Introduction to Git Hub & Regular Expressions

- [Optional]"Reading" (after class):
    - Code Academy Git Tutorial: https://www.codecademy.com/learn/learn-git 


## Module 14, 12/10/2020: Reading Day 
