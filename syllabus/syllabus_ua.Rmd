...
officehours: Tues 2-4PM; and by appt
office: "EDU 313"
...
## Lecture 2, 9/4/2019: Introduction to using tidyverse to investigate data patterns
...
## Lecture 3, 9/11/2019: Introduction to using "base R" to investigate data patterns
...
## Lecture 4, 9/18/2019: Pipes and variable creation
...
## Lecture 5, 9/25/2019:  Processing across rows
...
## Lecture 6, 10/2/2019:  Augmented vectors, Survey data, and exploratory data analysis
...
## Lecture 7, 10/9/2019:  Guidelines for investigating, cleaning, and creating variables
- Problem set due (before class): Yes
- Reading (after class): TBD

## Lecture 8, 10/16/2019:  Tidy Data
...
## Lecture 9, 10/23/2019:  Joining multiple datasets

- Problem set due (before class): Yes
- Reading (after class): W&G 13

## Lecture 10, 10/30/2019:  Acquiring data

- Problem set due (before class): Yes
- Reading (after class): W&G 11

## Lecture 11, 11/6/2019:  Working with Strings and Date/Time Variables

- Problem set due (before class): Yes
- Reading (after class): W&G 19


## Lecture 12, 11/13/2019: : No class (ASHE)

- Problem set due: Yes


## Lecture 13, 11/20/2019: : Accessing object elements and looping 

- Problem set due (before class): Yes
- Reading (after class): W&G 20.4 - 20.5; 21.1 - 21.3


## Lecture 14, 11/27/2019: : No class (Thanksgiving)

- Problem set due (before class): Yes


## Lecture 15, 12/4/2019: : Introduction to Git Hub 

- "Reading" (after class):
    - Code Academy Git Tutorial: https://www.codecademy.com/learn/learn-git 


## Lecture 16, 12/11/2019: Catch-Up and/or Wrap-up 
