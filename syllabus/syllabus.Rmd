...
- Reading (after class): 
    ...
    - GW 20.6 - 20.7 (attributes and augmented vectors; do the best you can)    
...
- Problem set due (before class): Yes
- Reading (after class): 
    - XAG 4.3 (R Markdown, creating Beamer presentation) [LINK HERE](https://bookdown.org/yihui/rmarkdown/beamer-presentation.html)
