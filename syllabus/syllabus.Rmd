...
1. Manipulate the organizational structure of datasets
    ...
    - Tidy untidy data
1. Learn guidelines practical strategies for ensuring data quality when cleaning data and creating analysis variables variables
...
Students will complete 10 problem sets [REVISE?].  Problem sets are due by 12PM each Friday (right before the class meeting).  Late submissions will not receive points because we will discuss solutions during class [REVISE?]. 

The lowest grade will be dropped from the calculation of your final grade.  
...
Weekly required and optional reading will be posted on the "resources" page of the github course website [here](https://ozanj.github.io/rclass/resources/)
...
- `r advdate(fri, 7)`: Tidy data [ASHE CONFERENCE]
